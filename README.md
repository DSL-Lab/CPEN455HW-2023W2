...
For classification accuracy, we evaluate using both **accuracy** and **F1 score**. You can submit your classification results through the [project Hugging Face challenge page](https://huggingface.co/spaces/CPEN455-23W2/CPEN45523W2CourseProject). Our system will calculate accuracy and F1 score based on your submission, and then update the leaderboard accordingly.
